...
contract FlightSuretyApp {
    ...
    */
    ...
    modifier requireAirlineSubmittedFunding(){
        require(flightSuretyData.hasFundingBeenSubmitted(msg.sender),"Funding required at the time of registration");
        _;
    }
    ...
    */   
    ...
    {
        require(flightSuretyData.hasAirlineBeenAdded(airline),"Airline should be added");
        ...
        if(registeredAirlines.length < 5 ){
            ...
            flightSuretyData.addToRegisteredAirlines(airline);
            emit RegisteredAirline(airline); 
        }else{
            require(flightSuretyData.hasAirlineBeenRegistered(msg.sender)==true,"Requires registering airline is registered");
            require(!flightSuretyData.hasAirlineVotedFor(msg.sender,airline),"Requires registering airline hasn't already voted");
            uint votes=flightSuretyData.voteForAirline(msg.sender,airline);
    ...
    */  
    function registerFlight
                                ...
                                requireIsOperational
    {
       flightSuretyData.addToRegisteredFlights(airlineID,flight,timestamp); 
    }
    ...
    */  
                                ...
                                requireIsOperational
    {
        if(statusCode==STATUS_CODE_LATE_AIRLINE){
           flightSuretyData.creditInsurees(airline,flight,CREDIT_MULTIPLIER); 
        }
    }
...
function withdrawCredits() external requireIsOperational{
   flightSuretyData.withdrawCreditsForInsuree(msg.sender);
}
